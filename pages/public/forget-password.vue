	...
	<view class="page">
			...
			<form>
				<view class="form-box">
					...
					<view class="input">
						<input placeholder-class="input-placeholder" type="password" placeholder="请输入新密码" v-model="password">
					</view>
				</view>
				<view class="submit">
	...
	export default{
		...
		methods:{
			submit(){
				...
				this.$api.forgetPassword({password,username,vercode}).then(response=>{
					if(response.code==0){
						this.loading=false;
